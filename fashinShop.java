...
class fashinShop{
		...
		L2:while(true){
			...
			if(number.length()==10 || number.charAt(0)=='0'){
				...
				switch(option){
						case "y" : 
							continue L2;
						case "n" : System.out.println("Redirecting to the Home Page..");
							sleep(3000);
							homePage(); 
						break;
						default : System.out.println("Invalid Input... Redirecting to the Home Page..");
							sleep(3000);
							homePage();
							break;
			}
	...
	public static double priceChart(String size, int q){
		switch(size){
			case "xs" : return 600*q; 
			case "s" : return 800*q;
			case "m" : return 900*q; 
			case "l" : return 1000*q; 
			case "xl" : return 1100*q; 
			case "xxl" : return 1200*q; 
		}
		return 0;
	}
	///-------------------------><---------------------------------------
